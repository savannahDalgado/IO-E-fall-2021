...
function draw() {
    ...
    //button clears screen, poteniometer changes colour, light sensor changes size
    fill(0, 0, 255);
    noStroke();
    rect(0, 0, 100, 100);
    //    background(0, 0, 255);
    ...
    fill(0, 0, 255)
    ellipse(innerWidth / 2, innerHeight / 2, diameter0 * 2000, diameter0 * 2000);
    ellipseMode(RADIUS);

    h = diameter1;
    fill(h, s, b);
    stroke(0, 0, 255);
    //    ellipse(diameter1, diameter1, diameter1, diameter1);
    ellipseMode(RADIUS);

    ellipse(x, 500, diameter2 * 2, diameter2 * 2);
