...
let songtwo;
let songthree;
let update = diameter1;

function setup() {

    song = createAudio('assets/assets_sounds_clay.mp3');
    songtwo = createAudio('assets/assets_sounds_prism-2.mp3');
    songthree = createAudio('assets/assets_sounds_suspension.mp3');
...
function draw() {
    ...
    //button, light sensor, and potentiometer play a sound
    fill(255, 255, 255);
    noStroke();
    rect(0, 0, 100, 100);
    //    background(0, 0, 255);
    fill(0, 0, 0);
    text(latestData, 20, 20);

    fill(0, 0, 0);
    textSize(20);
    text("button", 565, 500);
    fill(r, g, 0);
    rect(500, innerHeight / 2, 200, 200)

    fill(0, 0, 0);
    text("light sensor", 850, 500);
    fill(r2, g2, 0);
    rect(800, innerHeight / 2, 200, 200)

    fill(0, 0, 0);
    text("potentiometer", innerWidth / 2 + 140, 500);
    fill(r3, g3, 0);
    rect(innerWidth / 2 + 100, innerHeight / 2, 200, 200)
